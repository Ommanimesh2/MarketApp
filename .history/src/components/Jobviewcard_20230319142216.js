...
const Jobviewcard = ({src}, jobtitle, worker,price,day,contact) => {
  console.log(src)
  return (
...
style={styles.imagelocate}
 ...
 ></Image>
  <Text style={styles.locationtext}>Roorkee, India</Text>
      ...
      <Text style={styles.joblasttext}>{price} </Text>
      <Text style={styles.joblasttext}>{day} </Text>
        </View>
        </View>
     </View>
  )
